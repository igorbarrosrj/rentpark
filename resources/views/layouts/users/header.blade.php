<header>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <a href="index.html"><img class="logo" src="{{ setting()->get('site_logo')}}"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav ml-auto">
        <a class="nav-item nav-link" href="#">{{ tr('hosts') }}</a>
        <a class="nav-item nav-link" href="#">{{ tr('booking_management') }}</a>
        ...
        @guest
          ...
          <a class="nav-item nav-link active" href="{{ route('register') }}">{{ tr('register') }}<span class="sr-only">(current)</span></a> 
        @else
          <div class="topbar-divider d-none d-sm-block"></div>
