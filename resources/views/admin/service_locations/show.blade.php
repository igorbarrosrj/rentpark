		            ...
		            <div class="box-body">
		              <table class="table table-bordered">
		                <tr>
		             	...
		             	<tr>
		             		<td>Picture</td>
		             		<td><img src="/uploads/admin/{{ $service_location->picture }}" style="width: 200px;height: 200px"></td>
		             	</tr>	
		             	...
		             	<tr>
		             		...
		             		<td>
		             			<a href="{{ route('admin.service_locations.delete',$service_location->id) }}" class="btn btn-danger">Delete</a>
               				</td>
		             	</tr>			             					
